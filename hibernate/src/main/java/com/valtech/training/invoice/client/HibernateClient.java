...
import com.valtech.training.invoice.OrderSummary;
import com.valtech.training.invoice.OrderSummaryId;
...
public class HibernateClient {
	public static void main(String[] args) throws ParseException {
	    ...
	    OrderSummaryId orderSummaryId=new  OrderSummaryId(product,order);
	    ses.persist(orderSummaryId);
	    
	    OrderSummary orderSummary=new OrderSummary(orderSummaryId,5);
